...
public class tree_orders {
	...
	public class TreeOrders {
		...
		private void inOrderTraversal(int index, ArrayList<Integer> result) {
		...
		private void preOrderTraversal(int index, ArrayList<Integer> result) {
			// TODO Auto-generated method stub
			if(index < n && index != -1) {
				result.add(key[index]);
		...
		private void postOrderTraversal(int index, ArrayList<Integer> result) {
			// TODO Auto-generated method stub
			if(index < n && index != -1) {
